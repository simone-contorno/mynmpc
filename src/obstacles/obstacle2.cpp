...
{     
    ...
    auto node = std::make_shared<rclcpp::Node>("obs2"); 
    ...
    MatrixXd robot_box;    
    pub_box = node->create_publisher<std_msgs::msg::Float32MultiArray>("/obs2/box", 1);
    ...
    auto sub_joint = 
        node->create_subscription<sensor_msgs::msg::JointState>("obs2/joint_states", 1, [&](sensor_msgs::msg::JointState::UniquePtr carr)
    {
    ...
    /* Pose */
    auto sub_pose = 
        node->create_subscription<nav_msgs::msg::Odometry>("/obs2/odom", 1, [&](nav_msgs::msg::Odometry::UniquePtr odom)
    {
        /* Get pose */
    ...
    pub_twist = node->create_publisher<geometry_msgs::msg::Twist>("/obs2/cmd_vel", 1);
